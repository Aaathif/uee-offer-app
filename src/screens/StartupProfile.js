    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          <Image source={require('../../assets/startup/gamestreet.jpg')} style={styles.profileImage} />
      ...
      <TouchableOpacity>
        <View style={styles.card}>
          <View style={styles.row}>
            <Image source={require('../../assets/startup/card.png')} style={styles.icon} />
      ...
      <TouchableOpacity>
        <View style={styles.card}>
          <View style={styles.row}>
            <Image source={require('../../assets/startup/badge.jpeg')} style={styles.icon} />
